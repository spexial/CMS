...
$(function(){
	//菜单隐藏展开
	var tabs_i=0
	$('.j_sfq_title').click(function(){
		var _self = $(this);
		var j = $('.j_sfq_title').index(_self);
		if( tabs_i == j ) return false; tabs_i = j;
		$('.j_sfq_title em').each(function(e){
			if(e==tabs_i){
				$('em',_self).removeClass('j_sfq_jt_m').addClass('j_sfq_jt_h');
			}else{
				$(this).removeClass('j_sfq_jt_h').addClass('j_sfq_jt_m');
			}
		});
