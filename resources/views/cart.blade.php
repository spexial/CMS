...
@section('content')
    ...
    <div class="row" style="margin-top: 70px;line-height: inherit;">
                ...
                @foreach($items as $item)
                    <tr>
                        <td class="col-sm-8 col-md-6">
                            <div class="media">
                                <a class="thumbnail pull-left" > <img class="media-object" src="{{'images'.$item->product->imageurl}}" style="width: 100px; height: 72px;"> </a>
